    ...
    $.chooser = function (el, options) {
        ...
        base.init = function () {
            ...
            base.$control.on("click.bootstrap-chooser", ".choice button.close", function (e) {
                ...
                for (var i = base.selected.length - 1; i >= 0; i--) {
            ...
            if (!base.options.max || base.selected.length < base.options.max) {
                ...
                if (selected) {
                    ...
                    if (index !== -1) {
                        ...
                        base._applySelected();
                        if ($.isFunction(base.options.select)) { base.options.select(); }
                    }
                }
            }
        };
        ...
        base._search = function (search) {
            ...
            $("li", base.$dropdown).each(function () {
                var item = $(this).text();
                if (base.selected.map(function (x) { return x.text; }).indexOf(item) !== -1) {
